...
// TryRegisterInsightsClient will attempt to register the system with Red Hat Insights.
...
func (connectResult *ConnectResult) TryRegisterInsightsClient() {
	if !features.AnalyticsFeature.Enabled {
		...
		slog.Info("Connecting to Red Hat Insights disabled (analytics feature disabled)")
