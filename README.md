...
2. Registers the system with Red Hat Lightspeed (formerly branded `Insights`). If the system is already
...
2. Unregisters the system from Red Hat Lightspeed (formerly branded `Insights`).
