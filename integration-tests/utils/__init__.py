...
def get_access_token_client_credentials(
    ...
    *,
    ...
    """
    Obtain an access token using OAuth2 client_credentials (service account style).

    ``token_url`` is typically ``sso_token_url`` in settings (realm …/protocol/openid-connect/token).
    """
